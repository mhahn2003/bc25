...
public class BellmanFordNavigator extends Globals {
    ...
    public static Direction getBestDirection(MapLocation target) throws GameActionException {
        ...
        int weight25 = canVisit25 ? paintHeuristic(location25) + (checkOpponents ? rc.senseNearbyRobots(location25, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight30 = canVisit30 ? paintHeuristic(location30) + (checkOpponents ? rc.senseNearbyRobots(location30, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight35 = canVisit35 ? paintHeuristic(location35) + (checkOpponents ? rc.senseNearbyRobots(location35, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight40 = canVisit40 ? paintHeuristic(location40) + (checkOpponents ? rc.senseNearbyRobots(location40, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight26 = canVisit26 ? paintHeuristic(location26) + (checkOpponents ? rc.senseNearbyRobots(location26, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight27 = canVisit27 ? paintHeuristic(location27) + (checkOpponents ? rc.senseNearbyRobots(location27, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight31 = canVisit31 ? paintHeuristic(location31) + (checkOpponents ? rc.senseNearbyRobots(location31, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight32 = canVisit32 ? paintHeuristic(location32) + (checkOpponents ? rc.senseNearbyRobots(location32, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight36 = canVisit36 ? paintHeuristic(location36) + (checkOpponents ? rc.senseNearbyRobots(location36, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight37 = canVisit37 ? paintHeuristic(location37) + (checkOpponents ? rc.senseNearbyRobots(location37, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight41 = canVisit41 ? paintHeuristic(location41) + (checkOpponents ? rc.senseNearbyRobots(location41, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight42 = canVisit42 ? paintHeuristic(location42) + (checkOpponents ? rc.senseNearbyRobots(location42, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight28 = canVisit28 ? paintHeuristic(location28) + (checkOpponents ? rc.senseNearbyRobots(location28, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight29 = canVisit29 ? paintHeuristic(location29) + (checkOpponents ? rc.senseNearbyRobots(location29, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight33 = canVisit33 ? paintHeuristic(location33) + (checkOpponents ? rc.senseNearbyRobots(location33, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight34 = canVisit34 ? paintHeuristic(location34) + (checkOpponents ? rc.senseNearbyRobots(location34, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight38 = canVisit38 ? paintHeuristic(location38) + (checkOpponents ? rc.senseNearbyRobots(location38, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight39 = canVisit39 ? paintHeuristic(location39) + (checkOpponents ? rc.senseNearbyRobots(location39, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight43 = canVisit43 ? paintHeuristic(location43) + (checkOpponents ? rc.senseNearbyRobots(location43, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight44 = canVisit44 ? paintHeuristic(location44) + (checkOpponents ? rc.senseNearbyRobots(location44, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight49 = canVisit49 ? paintHeuristic(location49) + (checkOpponents ? rc.senseNearbyRobots(location49, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight54 = canVisit54 ? paintHeuristic(location54) + (checkOpponents ? rc.senseNearbyRobots(location54, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight59 = canVisit59 ? paintHeuristic(location59) + (checkOpponents ? rc.senseNearbyRobots(location59, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight64 = canVisit64 ? paintHeuristic(location64) + (checkOpponents ? rc.senseNearbyRobots(location64, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight50 = canVisit50 ? paintHeuristic(location50) + (checkOpponents ? rc.senseNearbyRobots(location50, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight51 = canVisit51 ? paintHeuristic(location51) + (checkOpponents ? rc.senseNearbyRobots(location51, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight55 = canVisit55 ? paintHeuristic(location55) + (checkOpponents ? rc.senseNearbyRobots(location55, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight56 = canVisit56 ? paintHeuristic(location56) + (checkOpponents ? rc.senseNearbyRobots(location56, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight60 = canVisit60 ? paintHeuristic(location60) + (checkOpponents ? rc.senseNearbyRobots(location60, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight61 = canVisit61 ? paintHeuristic(location61) + (checkOpponents ? rc.senseNearbyRobots(location61, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight65 = canVisit65 ? paintHeuristic(location65) + (checkOpponents ? rc.senseNearbyRobots(location65, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight66 = canVisit66 ? paintHeuristic(location66) + (checkOpponents ? rc.senseNearbyRobots(location66, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight45 = canVisit45 ? paintHeuristic(location45) + (checkOpponents ? rc.senseNearbyRobots(location45, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight46 = canVisit46 ? paintHeuristic(location46) + (checkOpponents ? rc.senseNearbyRobots(location46, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight47 = canVisit47 ? paintHeuristic(location47) + (checkOpponents ? rc.senseNearbyRobots(location47, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight48 = canVisit48 ? paintHeuristic(location48) + (checkOpponents ? rc.senseNearbyRobots(location48, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight52 = canVisit52 ? paintHeuristic(location52) + (checkOpponents ? rc.senseNearbyRobots(location52, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight53 = canVisit53 ? paintHeuristic(location53) + (checkOpponents ? rc.senseNearbyRobots(location53, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight57 = canVisit57 ? paintHeuristic(location57) + (checkOpponents ? rc.senseNearbyRobots(location57, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight58 = canVisit58 ? paintHeuristic(location58) + (checkOpponents ? rc.senseNearbyRobots(location58, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight62 = canVisit62 ? paintHeuristic(location62) + (checkOpponents ? rc.senseNearbyRobots(location62, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight63 = canVisit63 ? paintHeuristic(location63) + (checkOpponents ? rc.senseNearbyRobots(location63, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight67 = canVisit67 ? paintHeuristic(location67) + (checkOpponents ? rc.senseNearbyRobots(location67, 10, opponentTeam).length : 0) : 1_000_000;
        ...
        int weight68 = canVisit68 ? paintHeuristic(location68) + (checkOpponents ? rc.senseNearbyRobots(location68, 10, opponentTeam).length : 0) : 1_000_000;
